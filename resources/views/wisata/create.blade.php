...
@section('content')
    ...
    <form action="{{ route('wisata.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card  p-3 ">
            <fieldset>
                <legend class="form-header">Tambah Data Wisata</legend>
                <hr>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_wisata" class="form-control" id="nama_wisata" required
                                class="@error('nama_wisata') is-invalid @enderror" />
                            @error('nama_wisata')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="harga" class="form-control" id="biaya"
                                class="@error('biaya') is-invalid @enderror" />
                            @error('biaya')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="time" name="jam_buka" class="form-control" id="buka"
                                class="@error('jam_buka') is-invalid @enderror" />
                            @error('jam_buka')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="time" name="jam_tutup" class="form-control" id="tutup"
                                class="@error('jam_tutup') is-invalid @enderror" />
                            @error('jam_tutup')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" id="summernote deskripsi" rows="10" name="deskripsi" class="form-control" required
                                class="@error('deskripsi') is-invalid @enderror"></textarea>
                            @error('deskripsi')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="wrapp-image" id="bannerWrapper">
                            ...
                            <input type="file" id="bannerInput" rows="10" name="banner"
                                class="form-control-file images @error('banner') is-invalid @enderror" />
