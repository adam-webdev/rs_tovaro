                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="no_ktp">No Induk Kependudukan (NIK) :</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Masukan keluhan..." name="keluhan" id="keluhan" rows="5"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="jadwal">Jadwal - Dokter - Poli :</label>
                            <select name="jadwalperiksa_id" id="jadwal" class="form-control">
                                <option value="">-- Pilih Jadwal - Dokter - Poli --</option>
                                @foreach ($jadwalperiksa as $jp)
                                    <option value="{{ $jp->id }}">Hari :{{ $jp->hari }}, Jam Mulai :
                                        {{ \Carbon\Carbon::parse($jp->jam_mulai)->format('H:i') }}, Jam Selesai :
                                        {{ \Carbon\Carbon::parse($jp->jam_selesai)->format('H:i') }},
                                        Dokter :
                                        {{ $jp->dokter->nama }}, Poli :
                                        {{ $jp->dokter->poli->nama_poli }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
