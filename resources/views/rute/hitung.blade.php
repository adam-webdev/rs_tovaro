...
@section('title', 'Perhitungan Rute')
@section('css')
    <style>
        #buttons {
            position: absolute;
...
@section('content')
    ...
    <form action="{{ route('rute.store') }}" method="POST">
        ...
        <div class="card  p-3 ">
            <fieldset>
                <legend class="form-header">Pencarian rute terpendek dengan algoritma Floydwarshall dan Dijkstra</legend>
                <hr>
                <p>Silahkan pilih lokasi awal dan tujuan untuk dilakukan perhitungan.</p>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row mt-2">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="awal" class="form-control" id="awal" required readonly
                                class="@error('awal') is-invalid @enderror" />
                            @error('awal')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="tujuan" class="form-control" id="tujuan" required readonly
                                class="@error('tujuan') is-invalid @enderror" />
                            @error('tujuan')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                ...
                <div class="mt-2 gap-2">
                    ...
                    <input type="submit" style="background: black;color:#fff;" class="btn  btn-send" value="Hitung">
                </div>
            </fieldset>
        </div>
    </form>
